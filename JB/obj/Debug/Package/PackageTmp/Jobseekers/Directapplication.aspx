...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ux_divback">
        <asp:Label ID="Label11" runat="server" CssClass="ux_simplefontwhite" Text="Application in progress..."></asp:Label>
    </div>
    <div class="ux_simpleboxdetail">
        <asp:Label ID="Label15" runat="server" CssClass="ux_fontredh1" Text="Quick Uploader"></asp:Label>
        <br />
        <br />
        <asp:Label ID="Label12" runat="server" CssClass="ux_Stylea2" Text="FirstName"></asp:Label>
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="Label13" runat="server" CssClass="ux_Stylea2" Text="LastName"></asp:Label>
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="Label14" runat="server" CssClass="ux_Stylea2" Text="Date of Birth"></asp:Label>
        <br />
        ...
        <asp:Image ID="Image8" class="ux_img_lt_calender" runat="server" ImageUrl="/images/sprite.gif"
            onmouseover="document.body.style.cursor='pointer'" onmouseout="document.body.style.cursor='default'"
            ImageAlign="AbsMiddle" />
        <br />
        <br />
        <asp:Label ID="Label20" runat="server" CssClass="ux_Stylea2" Text="Email"></asp:Label>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox6"
            CssClass="ux_Stylea2" ErrorMessage="X"></asp:RequiredFieldValidator>
        <br />
        <br />
        <asp:Label ID="Label16" runat="server" CssClass="ux_Stylea2" Text="Profile Summary"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox2" runat="server" CssClass="ux_TextBoxStyle" Height="100px"
            TextMode="MultiLine" Width="300px" Wrap="true"></asp:TextBox>
        <br />
        <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox2"
            CssClass="ux_Stylea1" ErrorMessage="X"></asp:RequiredFieldValidator>
        <asp:Label ID="Label17" runat="server" CssClass="ux_Stylea2" Text="Upload CV"></asp:Label>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="FileUpload1"
            CssClass="ux_Stylea1" ErrorMessage="X"></asp:RequiredFieldValidator>
        <asp:Label ID="Label18" runat="server" CssClass="ux_Stylea2" Text="Only support *.docx, *.pdf, *.doc &lt; 2mb"></asp:Label>
        <br />
        <br />
