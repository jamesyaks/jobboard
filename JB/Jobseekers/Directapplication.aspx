...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="simpleboxdetail">
        ...
        <asp:Image ID="Image8" class="img_lt_calender" runat="server" ImageUrl="/images/sprite.gif"
        ...
        <br />
        <asp:TextBox ID="TextBox2" runat="server" CssClass="TextBoxStyle" Height="100px"
