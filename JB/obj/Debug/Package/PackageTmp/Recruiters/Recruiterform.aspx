...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="ux_recbgstytle">
        <asp:Label ID="Label28" runat="server" CssClass="ux_ftwhitebd" Text="Profile"></asp:Label>
    </div>
    <div class="ux_setrightbg">
        ...
        <br />
        <br />
        <asp:Label ID="Label23" runat="server" CssClass="ux_ftgraybd" Text="Company Name"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox10" runat="server" CssClass="ux_TextBoxStyle"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="TextBox10"
            CssClass="ux_Stylepwd" ErrorMessage="X"></asp:RequiredFieldValidator>
        <br />
        <asp:Label ID="Label26" runat="server" CssClass="ux_ftgraybd" Text="Company Website"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox15" runat="server" CssClass="ux_TextBoxStyle"></asp:TextBox>
        <br />
        <asp:Label ID="Label27" runat="server" CssClass="ux_ftgraybd" Text="Company Intro"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox16" runat="server" CssClass="ux_TextBoxStyle" Height="50px"
            TextMode="MultiLine" Wrap="True" Width="400px"></asp:TextBox>
        <br />
        <asp:Label ID="Label25" runat="server" CssClass="ux_ftgraybd" Text="Business Detail"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox14" runat="server" CssClass="ux_TextBoxStyle" Height="100px"
            TextMode="MultiLine" Wrap="True" Width="400px"></asp:TextBox>
        <br />
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="TextBox11"
            CssClass="ux_Stylepwd" ErrorMessage="X"></asp:RequiredFieldValidator>
        <br />
        <asp:Label ID="Label21" runat="server" CssClass="ux_ftgraybd" Text="**This will be your user name"></asp:Label>
        <br />
        <asp:Label ID="Label24" runat="server" CssClass="ux_Stylepwd" Text="User already exists"
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="TextBox12"
            CssClass="ux_Stylepwd" ErrorMessage="X"></asp:RequiredFieldValidator>
        <br />
        <asp:Label ID="Label29" runat="server" CssClass="ux_ftgraybd" Text="Confirm Password"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox17" runat="server" CssClass="ux_TextBoxStyle" TextMode="Password"></asp:TextBox>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="TextBox13"
            CssClass="ux_Stylepwd" ErrorMessage="X"></asp:RequiredFieldValidator>
        <br />
        <asp:Label ID="Label22" runat="server" CssClass="ux_ftgraybd" Text="CompanyLogo"></asp:Label>
        <br />
        <asp:FileUpload ID="FileUpload1" runat="server" CssClass="ux_button" />
        <br />
...
%>
        ...
        <br />
        <asp:Label ID="Label31" runat="server" CssClass="ux_ftgraybd"></asp:Label>
        <br />
