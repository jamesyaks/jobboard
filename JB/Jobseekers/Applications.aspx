...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="simpleboxdetail">
        ...
        <div id="applicationsbreak">
            <div>
                <img alt="one" class="img_lt_one" src="/images/sprite.gif" />
                <asp:Label ID="Label11" runat="server" CssClass="simplefontblack" Text="Register to receive jobs by email!"
                    Width="200px"></asp:Label>
                <asp:Button ID="Button2" runat="server" CssClass="button" Text="Register   " OnClick="Button2_Click" />
            </div>
            <br />
            <div>
                <img alt="two" class="img_lt_two" src="/images/sprite.gif" />
                <asp:Label ID="Label12" runat="server" CssClass="simplefontblack" Text="Continue without registration"
                    Width="200px"></asp:Label>
